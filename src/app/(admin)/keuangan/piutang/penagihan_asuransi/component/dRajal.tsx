import { Card, CardBody, Table, TableBody, TableCell, TableColumn, TableHeader, TableRow, Select, SelectItem, Pagination, Button, Tooltip, CardFooter, Modal, ModalContent, useDisclosure, ModalHeader, ModalBody, ModalFooter } from "@heroui/react";
import { HiOutlinePencilSquare } from "react-icons/hi2";
import { RiFileExcel2Line } from "react-icons/ri";
import React, { useEffect, useMemo, useState } from "react";
import { BulanIndo } from "@/data/bulan";
import { DetailPiutang, loadDetailPenagihan, loadPiutangRajal, PiutangResponse } from "@/services/asuransi";
...
export default function DaftarPenARajal() {
    ...
    const fetchData = async () => {
        try {
            setLoading(true);
            const result = await loadPiutangRajal({
            ...
            <div className="flex flex-col gap-4">
                ...
                <Card>
                    <CardBody>
                        ...
                        >
                            <TableHeader>
                                <TableColumn>Nama Penjamin</TableColumn>
                                ...
                                {response?.data ? (
                                    ...
                                    <TableRow key={index}>
                                        ...
                                        <TableCell className="flex flex-wrap gap-3">
                                            {item.periode_tanggal_dari} s/d {item.periode_tanggal_sampai}
                                        </TableCell>
